...
export type ServerMessage =
  | { type: "agentCreated"; id: number; folderName: string; sessionTopic?: string; team?: Team }
  | { type: "agentTopicLoaded"; id: number; sessionTopic: string }
  | { type: "agentClosed"; id: number }
  | { type: "existingAgents"; agents: number[]; folderNames: Record<number, string>; agentMeta?: Record<number, { palette?: number; hueShift?: number; seatId?: string; team?: Team }> }
  | { type: "teamsUpdated"; teams: Team[] }
