...
export interface TeamZone {
  teamId: string
  color: string
  /** Tile rects belonging to this zone */
  rects: Array<{ col: number; row: number; w: number; h: number }>
  /** Seat UIDs in priority order for this team */
  preferredSeatUids: string[]
...
export interface OfficeLayout {
  ...
  /** Team zones for seat assignment priority */
  zones?: TeamZone[]
}
...
export interface Character {
  ...
  team?: { id: string; name: string; color: string; zone: string }
}
